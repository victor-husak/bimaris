  ...
  return (
    <NextLink
      className={clsx(
        ...
        {
          "after:absolute after:-top-3 after:-right-[15px] after:-bottom-3  after:-left-[15px] after:-z-1 after:rounded-lg after:bg-[#f4f5f8] after:opacity-0 after:transition-all after:duration-400":
            !!props.description,
