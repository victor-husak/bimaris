...
import type { CaseStudiesDomainListFiltersCombinedProps } from "./case-studies-domain-list-filters";
...
export const useCaseStudiesDomainListFilters = (
  props: CaseStudiesDomainListFiltersCombinedProps,
) => {
